...
\begin{enumerate}
    ...
    Using modular exponentiation, $2^{55} \equiv 128 \pmod{221}$.
    $128 \neq 1$ and $128 \neq 220$. Continue.
    \item \textbf{Squaring}: $x_1 = 128^2 \bmod 221 = 16384 \bmod 221 = 30$.
    $30 \neq 220$.
    \item \textbf{End of Loop}: We finished all $r-1$ squarings without seeing $n-1$.
    \item \textbf{Result}: Returns \textbf{Composite}. (128 squared became 30, which is $\neq -1$).
\end{enumerate}
